<?php /* |-a---a!  !-! */ include_once("../html/../html/navbar.php");
...
<div class="card mb-4">
      ...
      <div class="col-lg-12">
        ...
        <div class="demo-inline-spacing mt-3">
          <div class="list-group list-group-horizontal-md text-md-center">
            ...
            <a class="list-group-item list-group-item-action" id="profile-list-item" data-bs-toggle="list" href="#horizontal-profile">Orçamento</a>
  ...
  <?php /* |-a---a!  !-! */ include_once("../html/../html/navbar-dow.php"); ?>