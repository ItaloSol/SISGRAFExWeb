            ...
            <div class="tab-content px-0 mt-0">
              ...
              <div class="tab-pane fade" id="horizontal-campos">
                <div class="col-md">
                  ...
                  <div class="form-check form-check-inline">
                    <input class="form-check-input" type="checkbox" name="campos20" id="Prioridade" value="prioridade_op" />
                    <label class="form-check-label" for="Prioridade">Prioridade</label>
                  </div>
                  <div class="form-check form-check-inline">
                    <input class="form-check-input" type="checkbox" name="campos21" id="Observacoes" value="descricao" />
                    <label class="form-check-label" for="Observacoes">Observções</label>
                  </div>
                  <div class="form-check form-check-inline">
                    <input class="form-check-input" type="checkbox" name="campos22" id="Quantidade Entregue" value="QTD_ENTREGUE" />
                    <label class="form-check-label" for="Quantidade Entregue">Quantidade Entregue</label>
                  </div>
                  <div class="form-check form-check-inline">
                    <input class="form-check-input" type="checkbox" name="campos23" id="Quantidade Entregar" value="(QTD_ENTREGUE - quantidade) AS QTD_ENT" />
                    <label class="form-check-label" for="Quantidade Entregar">Quantidade a Entregar</label>
                  </div>
                  <div class="form-check form-check-inline">
                    <input class="form-check-input" type="checkbox" name="campos24" id="Previsão Inicio dos Trabalhos" value="PrevisãoInicioTrabalhos" />
                  ...
                  <div class="form-check form-check-inline">
                    <input class="form-check-input" type="checkbox" name="campos26" id="Data Expedição de Prova" value="DATA_EXPEDICAO_PROVA" />
