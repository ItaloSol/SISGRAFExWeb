...
>
  <head>
    ...
    <title>SISGRAFEx - Esqueceu a Senha?</title>
        ...
        <div class="authentication-inner py-4">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <h4 class="mb-2">Selecione sua Seção</h4>
              <p class="mb-4">Selecione sua Seção para atualização do banco de dados</p>
              <form id="formAuthentication" class="mb-3" action="cad_secao.php" method="POST">
                <div class="mb-3">
                      <div class="mt-2 mb-3">
