        ...
        <div class="authentication-inner py-4">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <p class="mb-4">Insira seu CPF para validação da conta e permisão de recuperação de senha</p>
              <form id="formAuthentication" class="mb-3" action="validarcpf.php" method="POST">
                <div class="mb-3">
