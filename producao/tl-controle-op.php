        ...
        <div class="accordion-body">
          <form action="tl-controle-op.php" method="POST">
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control" name="codOp" id="basic-default-fullname"
                placeholder="Insira o código da ordem de produção" />
            </div>
            <div class="form-check form-switch mb-2">
            ...
            <div class="mb-3">
              <label class="form-label" for="basic-default-fullname"></label>
              <input type="text" class="form-control" name="codOrc" id="basic-default-fullname"
                placeholder="Insira o código dor orçamento" />
            </div><br></br>
            <div class="form-check form-switch mb-2">
              ...
              <div id="accordionIcon-1" class="accordion-collapse collapse show" data-bs-parent="#accordionIcon">
                <div class="accordion-body">
                  <form method="POST" action="b-controle-save.php">
                    <button type="button" class="btn btn-primary botao" data-bs-toggle="modal"
                    ...
                    <a href="../relatorios/relatorio-op-prod.php?cod=<?= $CODIGO_OP ?>"
                      style="max-height: 38px; font-size: 15px" target="_blank"
                      class=" text-align-center btn rounded-pill btn-danger">
                    ...
                    <div class="mb-3">
                      ...
                      <input id="cod" value="<?= $Ordens_Selecionada['cod'] ?>" class="form-control" type="text"
                        placeholder="Código da OP" disabled />
                    </div>
                    <div class="mb-3">
                      <label for="orc" class="form-label">Nº do Orçamento</label>
                      <input id="orc" name="orc" value="<?= $Ordens_Selecionada['orcamento_base'] ?>" class="form-control"
                        type="text" placeholder="Código do orçamento" disabled />
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                      ...
                      <input id="cliente" name="cliente" class="form-control"
                        value="<?= $Tabela_Clientes_Selecionada['nome'] ?>" type="text" placeholder="Nome do cliente"
                        disabled />
                    </div>
                    <div>
                      <label for="exampleFormControlTextarea1" class="form-label">Observações do Orçamento</label>
                      <textarea type="text" name="descricao" class="form-control" id="exampleFormControlTextarea1"
                        rows="3"><?= $Ordens_Selecionada['descricao'] ?></textarea>
                    </div>
                    <div class="mb-3">
                      <label for="codprod" class="form-label">Cód Produto</label>
                      <input id="codprod" name="codprod" class="form-control"
                        value="<?= $Ordens_Selecionada['cod_produto'] ?>" type="text" placeholder="Código do produto"
                        disabled />
                    </div>
                    <div class="mb-3">
                      <label for="descprod" class="form-label">Descrição do Produto</label>
                      <input id="descprod" name="descprod" class="form-control"
                        value="<?= $Tabela_Produtos_Selecionada['descricao'] ?>" type="text"
                    ...
                    <div class="mb-3">
                      ...
                      <select class="form-select" id="tipotrabalho" name="tipotrabalho"
          ...
          <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
              ...
              <div class="modal-footer">
                <button type="submit" name="sim" class="btn btn-primary" data-bs-target="#modalToggle2"
                    ...
                    <div class="card mb-4">
                      ...
                      <div class="card-body">
                        <div class="mb-3 row">
                          <label for="html5-date-input" class="col-md-2 col-form-label">Aprovação do Cliente</label>
                          <div class="col-md-10">
                            <input class="form-control" name="D_apr_cliente" disabled type="date"
                              value="<?= $Ordens_Selecionada['data_apr_cliente'] ?>" id="html5-date-input" />
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="card-body">
                        <div class="form-floating">
                          ...
                          <div class="mb-3 row">
                            ...
                            <div class="col-md-10">
                              <input class="form-control" name="D_saida_expedicao" type="date"
                                value="<?= $Ordens_Selecionada['DT_SAIDA_EXPEDICAO'] ?>" id="html5-date-input" />
                            </div>
                          </div>
                          <div class="mb-3 row">
                            <label for="html5-date-input" class="col-md-6 col-form-label">Data Prevista para Entrega</label>
                            <div class="col-md-10">
                              <input class="form-control" name="D_data_entrega" type="date"
                                value="<?= $Ordens_Selecionada['data_entrega'] ?>" id="html5-date-input" />
                            </div>
                          </div>
                        </div>
                      </div>
                ...
                <div class="card-body">
                  ...
                  <div class="form-floating">
                    <div class="mb-3 ">
                      ...
                      <div class="col-md-10">
                        <input class="form-control" name="D_prova_pre" type="date"
                          value="<?= $Ordens_Selecionada['DT_ENTRADA_PRE_IMP_PROVA'] ?>" id="html5-date-input" />
                      </div>
                    </div>
                    <div class="mb-3 ">
                    ...
                    <div class="mb-3 ">
                      ...
                      <div class="col-md-10">
                        <input class="form-control" name="D_prova_1" type="date"
                          value="<?= $Ordens_Selecionada['data_1a_prova'] ?>" id="html5-date-input" />
                      </div>
                    </div>
                    <div class="mb-3 ">
                      <label for="html5-date-input" class="col-md-2 col-form-label">2º Prova</label>
                      <div class="col-md-10">
                        <input class="form-control" name="D_prova_2" type="date"
                          value="<?= $Ordens_Selecionada['data_2a_prova'] ?>" id="html5-date-input" />
                      </div>
                    </div>
                    <div class="mb-3 ">
                      <label for="html5-date-input" class="col-md-2 col-form-label">3º Prova</label>
                      <div class="col-md-10">
                        <input class="form-control" name="D_prova_3" type="date"
                          value="<?= $Ordens_Selecionada['data_3a_prova'] ?>" id="html5-date-input" />
                      </div>
                    </div>
                    <div class="mb-3 ">
                      <label for="html5-date-input" class="col-md-2 col-form-label">4º Prova</label>
                      <div class="col-md-10">
                        <input class="form-control" name="D_prova_4" type="date"
                          value="<?= $Ordens_Selecionada['data_4a_prova'] ?>" id="html5-date-input" />
                      </div>
                    ...
                    <div class="form-floating">
                      <div class="mb-3 row">
                        <label for="html5-date-input" class="col-md-6 col-form-label">Prazo de <b>entrega</b> da <b>PROVA
                            PRONTA</b></label>
                        <div class="col-md-10">
                          <input class="form-control" name="data_entrega_prova" type="date"
                            value="<?= $Ordens_Selecionada['data_entrega_prova'] ?>" id="html5-date-input" />
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="form-floating">
                    <div class="mb-3 row">
                      <label for="html5-date-input" class="col-md-6 col-form-label">Prazo de <b>entrega</b> da <b>PROVA
                          PRONTA</b></label>
                      <div class="col-md-10">
                        <input class="form-control" disabled name="data_entrega_prova" type="date"
                          value="<?= $Ordens_Selecionada['data_entrega_prova'] ?>" id="html5-date-input" />
                      </div>
                    </div>
                  </div>
              ...
              <?php if ($PROD_ADM_I == '1') { ?>
                <div class="row">
                  ...
                  <div class="mb-3 ">
                    ...
                    <div class="col-md-10">
                      <input class="form-control" name="D_entrada_PLOTTER" type="date"
                        value="<?= $Ordens_Selecionada['DT_ENTRADA_PLOTTER'] ?>" id="html5-date-input" />
                    </div>
                  </div>
                </div>
              <?php } else { ?>
                <div class="row">
                  <div class="mb-3 ">
                    <label for="html5-date-input" class="col-md-2 col-form-label">Entrada Pré-Imp</label>
                    <div class="col-md-10">
                      <input class="form-control" name="D_entrada_pre" disabled type="date"
                        value="<?= $Ordens_Selecionada['DT_ENTRADA_PRE_IMP'] ?>" id="html5-date-input" />
                    </div>
                  </div>
                  <div class="mb-3 ">
                    <label for="html5-date-input" class="col-md-2 col-form-label">Entrada na Digital</label>
                    <div class="col-md-10">
                      <input class="form-control" name="D_entrada_digital" disabled type="date"
                        value="<?= $Ordens_Selecionada['DT_ENT_DIGITAL'] ?>" id="html5-date-input" />
                    </div>
                  </div>
                  <div class="mb-3 ">
                    <label for="html5-date-input" class="col-md-2 col-form-label">Entrada na OffSet</label>
                    <div class="col-md-10">
                      <input class="form-control" name="D_entrada_off" disabled type="date"
                        value="<?= $Ordens_Selecionada['data_ent_offset'] ?>" id="html5-date-input" />
                    </div>
                  </div>
                  <div class="mb-3 ">
                    <label for="html5-date-input" class="col-md-2 col-form-label">Entrada na CTP</label>
                    <div class="col-md-10">
                      <input class="form-control" name="D_entradactp" disabled type="date"
                        value="<?= $Ordens_Selecionada['DT_ENTRADA_CTP'] ?>" id="html5-date-input" />
                    </div>
                  </div>
                  <div class="mb-3 ">
                    <label for="html5-date-input" class="col-md-2 col-form-label">Entrada na Tipografia</label>
                    <div class="col-md-10">
                      <input class="form-control" name="D_entrada_tipo" disabled type="date"
                        value="<?= $Ordens_Selecionada['data_ent_tipografia'] ?>" id="html5-date-input" />
                    </div>
                  </div>
                  <div class="mb-3 ">
                    <label for="html5-date-input" class="col-md-2 col-form-label">Entrada no Acabamento</label>
                    <div class="col-md-10">
                      <input class="form-control" name="D_entrada_acabamento" disabled type="date"
                        value="<?= $Ordens_Selecionada['data_ent_acabamento'] ?>" id="html5-date-input" />
                    </div>
                  </div>
                  <div class="mb-3 ">
                    <label for="html5-date-input" class="col-md-2 col-form-label">Entrada na Plotter</label>
                    <div class="col-md-10">
                      <input class="form-control" name="D_entrada_PLOTTER" disabled type="date"
                        value="<?= $Ordens_Selecionada['DT_ENTRADA_PLOTTER'] ?>" id="html5-date-input" />
                    </div>
                  </div>
                </div>
              ...
              <?php if ($PROD_ADM_I == '1') { ?>
                <div class="row">
                  <div class="mb-3 ">
                    ...
                    <div class="col-md-10">
                      <input class="form-control" name="D_SAIDA_pre" type="date"
                        value="<?= $Ordens_Selecionada['SAIDA_PRE'] ?>" id="html5-date-input" />
                    </div>
                  </div>
                  <div class="mb-3 ">
                    <label for="html5-date-input" class="col-md-2 col-form-label">SAIDA na Digital</label>
                    <div class="col-md-10">
                      <input class="form-control" name="D_SAIDA_digital" type="date"
                        value="<?= $Ordens_Selecionada['SAIDA_DIGITAL'] ?>" id="html5-date-input" />
                    </div>
                  </div>
                  <div class="mb-3 ">
                    <label for="html5-date-input" class="col-md-2 col-form-label">SAIDA na OffSet</label>
                    <div class="col-md-10">
                      <input class="form-control" name="D_SAIDA_off" type="date"
                        value="<?= $Ordens_Selecionada['SAIDA_OFFSET'] ?>" id="html5-date-input" />
                    </div>
                  </div>
                  <div class="mb-3 ">
                    <label for="html5-date-input" class="col-md-2 col-form-label">SAIDA na CTP</label>
                    <div class="col-md-10">
                      <input class="form-control" name="D_SAIDActp" type="date"
                        value="<?= $Ordens_Selecionada['SAIDA_CTP'] ?>" id="html5-date-input" />
                    </div>
                  </div>
                  <div class="mb-3 ">
                    <label for="html5-date-input" class="col-md-2 col-form-label">SAIDA na Tipografia</label>
                    <div class="col-md-10">
                      <input class="form-control" name="D_SAIDA_tipo" type="date"
                        value="<?= $Ordens_Selecionada['SAIDA_TIPOGRAFIA'] ?>" id="html5-date-input" />
                    </div>
                  </div>
                  <div class="mb-3 ">
                    <label for="html5-date-input" class="col-md-2 col-form-label">SAIDA no Acabamento</label>
                    <div class="col-md-10">
                      <input class="form-control" name="D_SAIDA_acabamento" type="date"
                        value="<?= $Ordens_Selecionada['SAIDA_ACABAMENTO'] ?>" id="html5-date-input" />
                    </div>
                  </div>
                  <div class="mb-3 ">
                    <label for="html5-date-input" class="col-md-2 col-form-label">SAIDA na Plotter</label>
                    <div class="col-md-10">
                      <input class="form-control" name="D_SAIDA_PLOTTER" type="date"
                        value="<?= $Ordens_Selecionada['SAIDA_PLOTTER'] ?>" id="html5-date-input" />
                    </div>
                  </div>
                </div>
              <?php } else { ?>
                <div class="row">
                  <div class="mb-3 ">
                    <label for="html5-date-input" class="col-md-2 col-form-label">SAIDA na Pré-Imp</label>
                    <div class="col-md-10">
                      <input class="form-control" name="D_SAIDA_pre" disabled type="date"
                        value="<?= $Ordens_Selecionada['SAIDA_PRE'] ?>" id="html5-date-input" />
                    </div>
                  </div>
                  <div class="mb-3 ">
                    <label for="html5-date-input" class="col-md-2 col-form-label">SAIDA na Digital</label>
                    <div class="col-md-10">
                      <input class="form-control" name="D_SAIDA_digital" disabled type="date"
                        value="<?= $Ordens_Selecionada['SAIDA_DIGITAL'] ?>" id="html5-date-input" />
                    </div>
                  </div>
                  <div class="mb-3 ">
                    <label for="html5-date-input" class="col-md-2 col-form-label">SAIDA na OffSet</label>
                    <div class="col-md-10">
                      <input class="form-control" name="D_SAIDA_off" disabled type="date"
                        value="<?= $Ordens_Selecionada['SAIDA_OFFSET'] ?>" id="html5-date-input" />
                    </div>
                  </div>
                  <div class="mb-3 ">
                    <label for="html5-date-input" class="col-md-2 col-form-label">SAIDA na CTP</label>
                    <div class="col-md-10">
                      <input class="form-control" name="D_SAIDActp" disabled type="date"
                        value="<?= $Ordens_Selecionada['SAIDA_CTP'] ?>" id="html5-date-input" />
                    </div>
                  </div>
                  <div class="mb-3 ">
                    <label for="html5-date-input" class="col-md-2 col-form-label">SAIDA na Tipografia</label>
                    <div class="col-md-10">
                      <input class="form-control" name="D_SAIDA_tipo" disabled type="date"
                        value="<?= $Ordens_Selecionada['SAIDA_TIPOGRAFIA'] ?>" id="html5-date-input" />
                    </div>
                  </div>
                  <div class="mb-3 ">
                    <label for="html5-date-input" class="col-md-2 col-form-label">SAIDA no Acabamento</label>
                    <div class="col-md-10">
                      <input class="form-control" name="D_SAIDA_acabamento" disabled type="date"
                        value="<?= $Ordens_Selecionada['SAIDA_ACABAMENTO'] ?>" id="html5-date-input" />
                    </div>
                  </div>
                  <div class="mb-3 ">
                    <label for="html5-date-input" class="col-md-2 col-form-label">SAIDA na Plotter</label>
                    <div class="col-md-10">
                      <input class="form-control" name="D_SAIDA_PLOTTER" disabled type="date"
                        value="<?= $Ordens_Selecionada['SAIDA_PLOTTER'] ?>" id="html5-date-input" />
                    </div>
                  </div>
                </div>
                ...
                <div class="card-body">
                  <form method="POST" action="tl-controle-op.php?cod=<?= $Ordens_Selecionada['cod'] ?>&obs=1">
                    <div class="mb-3">
                      ...
                      <textarea name="Observacao_nova" id="Observacao_nova" class="form-control"
                        placeholder="Qual a Anotação para esta OP?" rows="10" cols="50"></textarea>
                    </div>
