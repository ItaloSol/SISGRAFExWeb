                  ...
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                      ...
                      <h5 class="mb-0">Informações do Cliente</h5>
                        ...
                        <div class="row mb-3">
                          <label class="col-sm-2 col-form-label" for="basic-default-company">Tipo de Pessoa</label>
                          <div class="col-sm-10">
                            <input
                              type="text"
                              class="form-control"
                        ...
                        <div class="row mb-3">
                          <label class="col-sm-2 col-form-label" for="basic-default-email">Código do Cliente</label>
                          <div class="col-sm-10">
